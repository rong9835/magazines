...
const MagazinesComponent = () => {
  const articles = [
    {
      id: 1,
      title: "2025년 AI 트렌드: 생성형 AI의 진화",
      description: "ChatGPT를 넘어서는 차세대 AI 기술과 산업\n전반의 변화를 살펴봅니다",
      category: "인공지능",
      categoryColor: "#8b5cf6",
      tags: ["#생성형AI", "#멀티모달", "#ChatGPT", "#머신러닝"],
      imageUrl: "/api/placeholder/323/200"
    },
    {
      id: 2,
      ...
      <div className={styles.header}>
        ...
        <div className={styles.headerButtons}>
          <button className={styles.loginButton}>
            <svg className={styles.buttonIcon} width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path d="M9 1L16 9L9 17M15 9H1" stroke="#6b7280" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            로그인
          </button>
          <button className={styles.writeButton}>
            <svg className={styles.buttonIcon} width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path d="M1 12L7 6L11 10L17 4" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            글쓰기
          </button>
          <button className={styles.subscribeButton}>
            <svg className={styles.buttonIcon} width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path d="M9 1L11.5 6.5L17 9L11.5 11.5L9 17L6.5 11.5L1 9L6.5 6.5L9 1Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            구독하기
          </button>
        </div>
